...
import 'package:take_a_plate/MULTI-PROVIDER/ContactUsProvider.dart';
import 'package:take_a_plate/MULTI-PROVIDER/DateProvider.dart';
import 'package:take_a_plate/MULTI-PROVIDER/GenderProvider.dart';
import 'package:take_a_plate/MULTI-PROVIDER/AuthenticationProvider.dart';
import 'package:take_a_plate/MULTI-PROVIDER/RestaurantsListProvider.dart';
import 'package:take_a_plate/MULTI-PROVIDER/SignUp_StepOne.dart';
import 'package:take_a_plate/MULTI-PROVIDER/selectImageProvider.dart';
import 'package:take_a_plate/SCREENS/last_minute_deal/last_minute_deal_screen.dart';
  ...
  return MultiProvider(
    ...
    MaterialApp(
      ...
      routes: {
        ...
        '/PassWordSentScreen': (context) => const PassWordSentScreen(),
        '/SignupScreen': (context) => SignUpScreen(),
        '/UploadPhoto': (context) => const UploadPhoto(),
        '/SetYourPasswordScreen': (context) => SetYourPasswordScreen(),
        '/NotificationTurnOnScreen': (context) => const NotificationTurnOnScreen(),
        '/BaseHome': (context) => BaseHome(),
        '/OrderAndPayScreen': (context) => OrderAndPayScreen(),
        '/PaymentDetailsScreen': (context) => const PaymentDetailsScreen(),
        ...
        '/ClosestScreen': (context) => const ClosestScreen(),
        '/LastMinuteDealScreen': (context) => const LastMinuteDealScreen(),
        '/NotificationCenterScreen': (context) => const NotificationCenterScreen(),
        '/YourNotificationScreen': (context) => const YourNotificationScreen(),
        ...
        '/CollectTomorrowScreen': (context) => const CollectTomorrowScreen(),
        '/PreviousOrderScreen': (context) => const PreviousOrderScreen(),
