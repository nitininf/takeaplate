...
const String delight = "Delight In The Thrill Of Exploring New Cuisines And Unique Eateries With Last-Minute Deals That Turn Every Meal";
const String sentPss = "YOUR PASSWORD HAS \n BEEN SENT TO YOUR EMAIL.";
const String checkInbox = "PLEASE CHECK YOUR INBOX.";
const String favRes = "NEW DEAL FROM YOUR FAVOURITE RESTAURENT!";
